...
abstract class DouyinFlutterPluginPlatform extends PlatformInterface {
  /// Constructs a DouyinFlutterPluginPlatform.
  ...
  /// The default instance of [DouyinFlutterPluginPlatform] to use.
  ///
  /// Defaults to [MethodChannelDouyinFlutterPlugin].
  static DouyinFlutterPluginPlatform get instance => _instance;

  /// Platform-specific implementations should set this with their own
  /// platform-specific class that extends [DouyinFlutterPluginPlatform] when
